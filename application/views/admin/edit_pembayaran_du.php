                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Edit Pembayaran Daftar Ulang</h5>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form class="form-horizontal" action="<?php echo base_url('webmin/du/editdu'); ?>" method="post">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="herreg" name="herreg" value="<?= $her; ?>" onkeyup="convertToRupiah(this)" onchange="JumlahTotal()" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="spp" class="col-sm-4 col-form-label">SPP</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="spp" name="spp" value="<?= $spp; ?>" onkeyup="convertToRupiah(this)" onchange="JumlahTotal()" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="ujian" class="col-sm-4 col-form-label">Ujian (UTS & UAS)</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="ujian" name="ujian" value="<?= $ujian; ?>" onkeyup="convertToRupiah(this)" onchange="JumlahTotal()" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="dpp" class="col-sm-4 col-form-label">DPP</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="dpp" name="dpp" value="<?= $dpp; ?>" onkeyup="convertToRupiah(this)" onchange="JumlahTotal()" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="posmaru" class="col-sm-4 col-form-label">Lain-lain (Posmaru)</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="posmaru" name="posmaru" value="<?= $posmaru; ?>" onkeyup="convertToRupiah(this)" onchange="JumlahTotal()" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="kopertais" class="col-sm-4 col-form-label">Kopertais</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="kopertais" name="kopertais" value="<?= $kopertais; ?>" onkeyup="convertToRupiah(this)" onchange="JumlahTotal()" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="jumlah" class="col-sm-4 col-form-label">Jumlah</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="jumlah" name="jumlah" value="<?= $jumlah; ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="ket" class="col-sm-4 col-form-label">Keterangan</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="ket" name="ket" value="<?= $ket; ?>" placeholder="Keterangan Bila Ada">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="" class="col-sm-4 col-form-label"></label>
