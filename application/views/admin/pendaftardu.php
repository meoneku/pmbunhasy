      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Data Pendaftar Daftar Ulang</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                              ...
                              <td class="text-center">
                                <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                    <li><a class="dropdown-item" tabindex="1" href="<?php echo base_url('webmin/admin/cetak_berkas_du/') . url_encode($pendaftar['nomor']); ?>"><i class="fas fa-file"></i> Cetak Berkas Daftar Ulang</a></li>
                                    <div class="dropdown-divider"></div>
                                    <li><a class="dropdown-item" tabindex="1" href="<?php echo base_url('webmin/admin/ubah_jas/') . url_encode($pendaftar['nomor']); ?>"><i class="fas fa-tshirt"></i> Ubah Ukuran Almamater</a></li>
                                  </ul>
                                </div>
                              </td>
                              <td class="text-center"><?php echo $pendaftar['nim_pdti']; ?></td>
