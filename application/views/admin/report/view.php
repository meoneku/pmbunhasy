          ...
          <div class="col-md-12">
            ...
            <div class="card-body">
              <table id="pendaftar" class="table table-bordered table-hover">
                ...
                <tr>
				  ...
				  <td class="text-center"><?php echo $personal['nomor'];?></td>
                  <td><?php echo $personal['nama'];?></td>
                  <td><?php echo $personal['jalur'];?></td>
				  ...
				  <td class="text-center"><?php echo $personal['nilai'];?></td>
                </tr>
				<?php $no++;}?>
                </tbody>
                <tfoot>
            ...
            <!-- /.card-body -->
              ...
              <div class="card-footer">
                <div class="row">
				  <div class="col-sm-2">
					<a href="<?php echo base_url('webmin/admin/report');?>" type="button" class="btn btn-block btn-primary"><i class="fas fa-chevron-circle-left"></i> Kembali</a>
				  </div>
				  <div class="col-sm-2">
					<a href="<?php echo base_url('webmin/report/toxlsx').$link;?>" type="button" class="btn btn-block btn-success"><i class="fas fa-file-excel"></i> Export Ke XLSX</a>
				  </div>
				  <div class="col-sm-2">
					<a href="<?php echo base_url('webmin/report/topdf').$link;?>" type="button" class="btn btn-block btn-danger"><i class="fas fa-file-pdf"></i> Export Ke PDF</a>
				  </div>
                </div>
                </div>
                <!-- /.row -->
